  ...
  <div class="box box-primary">
    ...
    <div class="box-body no-padding">
      <div class="mailbox-controls">
        ...
        <form id="deleteAll" class="btn-group" action="/delete?t=inbox" method="post">
        ...
        <div class="pull-right">
          ...
          <div class="btn-group">
            <a href="/inbox?page=${page.pageNumber-1}" class="btn btn-default btn-sm ${page.pageNumber==1?'disabled':''}">
              <i class="fa fa-chevron-left"></i></a>

            <a href="/inbox?page=${page.pageNumber+1}" class="btn btn-default btn-sm ${page.pageNumber==page.totalOfPages?'disabled':''}">
        ...
        <table class="table table-hover table-striped">
          <tbody>
            <c:forEach items="${page.gmails}" var="gmail" varStatus="loop">
              <tr data-href="/read?t=inbox&o=${loop.index}">
